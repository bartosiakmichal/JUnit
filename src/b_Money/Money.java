...
public class Money implements Comparable {
    ...
    public Integer getAmount() {
        //zwracam Integer, bo w innych metodach wykorzystywany jest Integer
        return amount;
    }
    ...
    public String toString() {
        ...
        if (amount == 0) {
            ...
            value = String.format("%.2f", amount * 0.01).replace(",", ".");
    ...
    public Money add(Money other) {
        Money result;
        Integer convertMoney;
        convertMoney = currency.valueInThisCurrency(other.amount, other.currency);
        result = new Money(this.amount + convertMoney, this.currency);
        return result;
    }
    ...
    public Money negate() {
        Money result;
        result = new Money(this.amount * -1, this.currency);
        return result;
    ...
    public int compareTo(Object other) {
        ...
        if (this.universalValue() < otherMoney.universalValue()) {
            return -1;
        }
        if (this.universalValue() > otherMoney.universalValue()) {
            return 1;
